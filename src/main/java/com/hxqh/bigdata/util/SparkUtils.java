...
import com.hxqh.bigdata.spark.session.MockData;
...
public class SparkUtils {
    ...
    /**
     * 根据当前是否本地测试的配置,设置SparkConf的master
     */
    ...
    /**
     * 获取SQLContext
     * 如果spark.local设置为true，那么创建SQLContext；否则，创建HiveContext
     *
     * @param sc
     * @return
     */
...
//				+ "and session_id not in('','','')"
         ...
         *
         * 就可以对Spark SQL刚刚查询出来的RDD执行repartition重分区操作
         *
         *
